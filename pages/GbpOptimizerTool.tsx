...
// FIX: Remove import from deprecated geminiService.
...
const GbpOptimizerTool: React.FC<GbpOptimizerToolProps> = ({ onBackToDashboard }) => {
    ...
    // FIX: Use Convex actions instead of client-side service.
    const generateGbpDescription = useAction(api.generations.generateGbpDescription);
    const generateGbpServiceDescription = useAction(api.generations.generateGbpServiceDescription);
    ...
    }, [businessName, address, categories, services, usp, tone, generateGbpDescription]);
    ...
    }, [services, businessName, address, categories, tone, isGeneratingServices, generateGbpServiceDescription]);
